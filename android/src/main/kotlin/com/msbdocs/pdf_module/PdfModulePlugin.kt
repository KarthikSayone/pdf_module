...
/** PdfModulePlugin */
class PdfModulePlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    ...
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "pdf_module")
  ...
  private fun openFileDoc(pdfFilePath: String): PdfRenderer {
    val fd = ParcelFileDescriptor.open(File(pdfFilePath), ParcelFileDescriptor.MODE_READ_ONLY)
